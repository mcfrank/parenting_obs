...
```{r, parent-ed-effect, echo=F, fig.cap="Posterior distribution of parent education coefficient with mean (red), 89% CIs (blue), and *pd* (orange portion) shown.", fig.width=4, fig.height=2.0}
...
```{r, plot-token-posterior, echo=F, fig.width=6, fig.height=6, fig.cap="Posterior distributions with means and 89% credible intervals. The outermost 5% of each posterior distribution is clipped and not shown."}
...
```{r, echo=F, fig.width=6, fig.height=6, fig.cap="Posterior distributions for regression predicting TTR, with means and 89% credible intervals. The outermost 5% of each posterior distribution is clipped and not shown.", warning=F}
plot_posterior(ttr_modE1, "Exp. 1: TTR")
```



```{r, echo=F, fig.width=6, fig.height=6, fig.cap="Posterior distributions for regression predicting MTLD, with means and 89% credible intervals. The outermost 5% of each posterior distribution is clipped and not shown."}
