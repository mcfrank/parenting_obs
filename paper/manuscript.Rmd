...
Attempting to reproduce the surface details of a video-guided activity could in turn result in less high-quality talk, with less responsiveness to their child's play.
...
They were not given any additional instructions about how to use the props.^[Based on piloting, we estimated these activities would would only require three minutes to complete.]
