...
The two coders had a reliability of ICC = 0.79 with 95% confidence interval (CI) = [0.55,0.91] for number of parent bids for JA; ICC = 0.34 with 95% CI = [-0.11,0.67] for number of passive JA episodes; ICC = 0.66 with 95% CI = [0.32,0.85] for number of coordinated JA episodes; ICC = 0.33 with 95% CI = [-0.11,0.67] for total duration of passive JA episodes, and ICC = 0.60 with 95% CI = [0.24,0.82] for total duration of coordinated JA episodes. 
...
summary(tokens_mod)
e1tokens = get_stan_glmer_reporting_values(tokens_mod, "conditionexp") # 59.5
...
# predict # of conversational turns
modCT <- stan_glmer(Conversational_Turns ~ condition * age + (1|video), data=e1ld)
summary(modCT) 
get_stan_glmer_reporting_values(modCT, "conditionexp") # pd = .92
# E1 CT: exp early significant (+ effect)
# E2 CT: age nearly significany (+ effect)
```
