...
abstract: |
  Early parenting practices help shape children’s future outcomes. In particular, high-quality early interactions can facilitate language learning and school performance. Phone-based parenting applications can deliver low-cost interventions on parenting style. In two studies (N=142; 79 female; ages 6-24 months; 74 white, 31 Asian, 31 biracial, 3 black, 12 other; 31 Hispanic), we investigated effects of short videos on parent behavior. After parents watched videos depicting age-appropriate parent-child activities, parents spoke more (d=0.83) and made more bids for joint attention (d=1.03). These results suggest that activity videos can lead to local changes in parent engagement, providing support for the use of such videos as a part of broader app-based parenting interventions.
