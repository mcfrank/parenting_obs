...
p_direction(types_mod, effects="all") # condition 80%, age 78, cond*age 84%..
...
p_direction(modTTRE, effects="all") # RR 91.00%  parent_ed 92.17%

modMTLDE <- stan_glmer(paste("MTLD", e1model_string), data=e1ld)
summary(modMTLDE) #
p_direction(modMTLDE, effects="all") # AA 85.60% RR 85.02% age 55.80% genderM 85.12%
