...
abstract: |
  Early parenting practices help shape children’s future outcomes. In particular, high-quality early interactions can facilitate language learning and school performance. Phone-based parenting applications can deliver low-cost interventions on parenting style, yet relatively little is known about the efficacy of this approach. In two studies (N=142; 79 female; ages 6-24 months), we investigated effects of short videos on parent behavior. Parents watched videos depicting age-appropriate parent-child activities from a parenting app. After watching the videos, parents spoke more and made more bids for joint attention. These results suggest that activity videos can lead to local changes in parent engagement, providing support for the use of such videos as a part of broader app-based parenting interventions.
